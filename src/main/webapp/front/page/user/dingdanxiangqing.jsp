...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/front/css/style.css">
</head>
<body>
	<!-- start header -->
		...
		<div class="top center">
			<div class="right fr">
				<div class="gouwuche fr">
					<a href="javascript:gowuche();">购物车</a>
				</div>
				<div class="fr">
					<ul>
						<%
						...
						<%
								...
								UserCrmModel userCrm = (UserCrmModel) obj;
						%>
						<li><a href="javascript:dingdan();">我的订单[<%=userCrm.getUsername()%>]
						</a></li>
						<li>|</li>
	...
	<div class="banner_x center">
		<a href="/spring05/front/page/home/main.jsp" target="_blank"><div
		...
		<div class="search fr">
			<form
				action="<%=request.getContextPath()%>/front/page/product/list.jsp"
				method="post">
				<div class="text fl">
	...
	<div class="grzxbj">
		<div class="selfinfo center">
			<div class="lfnav fl">
				<div class="ddzx">订单详情</div>
				<div class="subddzx">
					<ul>
						<li><a href="" style="color: #ff6700; font-weight: bold;">订单商品</a></li>
						<li><a href="">意外保</a></li>
						<li><a href="">团购订单</a></li>
						<li><a href="">评价晒单</a></li>
					</ul>
	...
	<footer class="mt20 center">
		<div>©mi.com 京ICP证110507号 京ICP备10046444号 京公网安备11010802020134号京网文[2014]0059-0009号</div>
...
<script type="text/javascript">
		...
		var searchParam={
			...
			ajax('/orderprod/getList.do',searchParam ,'json', getList);
		}
...
<tr>
<td>{{ d.i }}</td><td>{{ d.orderCode }}</td><td>{{ d.spname }}</td>
<td>{{ d.count }}</td><td>{{ d.sum }}</td>
</tr>
</script>
</html>
